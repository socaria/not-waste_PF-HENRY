...
function Cart() {
  ...
  return (
    <div>
      <div width='50px' className="mx-4" variant="primary" onClick={handleShow} id='logocart'>
      ...
      <Offcanvas show={show} onHide={handleClose} aria-controls="offcanvasRight">
        <Offcanvas.Header className='mt-1  p-1'>
          <Offcanvas.Title className='d-flex align-items-center mx-2'>
            ...
            <span className='mx-4'>Tu Carrito</span>
          </Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body>
          <Card>
            ...
            <Card.Footer className='d-flex justify-content-center'>
              <Button variant='dark' className='d-flex w-50 justify-content-center'>Pagar</Button>
            </Card.Footer>
          </Card>
        </Offcanvas.Body>
      </Offcanvas>
