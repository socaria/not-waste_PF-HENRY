              ...
              return (
                <ListGroup.Item key={post.id}>
                  <div className='d-flex align-items-center'>
                    ...
                    <Button className='btn btn-danger m-1 p-1'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart-plus" viewBox="0 0 16 16">
