        ...
        {!input.supplier ? <>
          ...
          <div className="m-0 row justify-content-center">
            <div className="col-auto p-5 text-center" id="contForm">
              ...
              <div className="input-group has-validation">
                <div className="form-floating is-invalid">
                  <input type="text" className={!error.namesupplier ? 'form-control ms-2' : "form-control is-invalid ms-2"} id="inputForm" placeholder="Name" name='namesupplier' required onChange={(e) => changeState(e)} />
              ...
              <div className="input-group has-validation">
                <div className="form-floating is-invalid">
                  <input type="tel" className={!error.phone ? 'form-control ms-2' : "form-control is-invalid ms-2"} id="inputForm" placeholder="phone" name='phone' required onChange={(e) => changeState(e)} />
              ...
              <div className="input-group has-validation">
                <div className="form-floating is-invalid">
                  <input type="text" className={!error.adress ? 'form-control ms-2' : "form-control is-invalid ms-2"} id="inputForm" placeholder="adress" name='adress' required onChange={(e) => changeState(e)} />
              ...
              <div className="input-group has-validation">
                <div className="form-floating is-invalid">
                  <input type="tel" className={!error.cuit ? 'form-control ms-2' : "form-control is-invalid ms-2"} id="inputForm" placeholder="cuit" name='cuit' required onChange={(e) => changeState(e)} />
              ...
              {/* <div className="form-control ms-2"> */}
                <select className="form-select form-select-lg ms-2" name='category' id="inputForm" aria-label=".form-select-lg example" onChange={(e) => changeState(e)} value={input.category}>
              ...
              <div className="col-12" >
                <button id="buttonRegister" className="btn btn-primary" type="submit" value='register' onClick={(event) => { registerSupplier(event) }}>Registrarse</button>
              </div>
            </div>
          </div>
        </>}
