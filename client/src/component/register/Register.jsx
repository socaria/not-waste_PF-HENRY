  ...
  return (<>
    <form className="form-check form-switch my-3 mx-5">
      <div class="text-center">
        <img src={props.picture} class="rounded" alt={props.name} width='100px' />
      </div>
      ...
      {!input.supplier ? <>
        ...
        <div className="col-12">
          <button className="btn btn-primary" type="submit" value='registerCustomer' onClick={(event) => { registerCustomer(event) }}>Confirm</button>
        </div> </> : <>

        <h5>Please upload the information requested in order to be a Not Waste supplier</h5>

        <div className="input-group has-validation">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" fill="currentColor" class="bi bi-emoji-heart-eyes" viewBox="0 0 16 16">
        ...
        <div className="input-group has-validation">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
        ...
        <div className="input-group has-validation">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" fill="currentColor" class="bi bi-bank" viewBox="0 0 16 16">
        ...
        <div className="col-12">
          <button className="btn btn-primary" type="submit" value='register' onClick={(event) => { registerSupplier(event) }}>Register</button>
        </div>
      </>}
