...
const { getSellerByCity, getSellers, postSeller, putSeller } = require("../controllers/seller");
const { getProductByCity, getProducts, postProduct, putProduct, deleteProduct } = require("../controllers/product");
